...
const Contact = () => {
    ...
    return (
        <section className="contact section" id="contact">
            ...
            <span className="section__subtitle"> Any questions, collaborations, or opportunities! Let’s connect and make things happen ! </span>
            ...
            <div>
                 <h3 className="contact__name"><span style={{ color: '#808080'}}> Location: </span> Periyathoodam, Karaveddi Center, Karaveddi, Jaffna,
                 Srilanka.</h3>
            </div>
            </div>
            ...
            <div>
                 <h3 className="contact__name"><span style={{ color: '#808080'}}> Email: </span>thushanthsbm1997@gmail.com&nbsp;  &nbsp; </h3> 
            </div>
         <i class='bx bx-phone-call' style={{ fontSize: '1.3rem', color: '#e42020' }}> </i> 
            <h3 className="contact__name"><span style={{ color: '#808080'}}> Call: </span> +94 773 559 319</h3>
            </div>
