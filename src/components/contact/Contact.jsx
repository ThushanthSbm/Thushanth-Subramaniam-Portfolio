  ...
  return (
    <section className="contact section" id="contact">
      ...
      <span className="section__subtitle">
        Any questions, collaborations, or opportunities! Let’s connect and make things happen!
      </span>
      ...
      <div className="contacts__data">
        <i className='bx bx-envelope' style={{ fontSize: '1.3rem', color: '#e42020' }}></i>
        <div>
          <h3 className="contact__name">
            <span style={{ color: '#808080' }}>Email:</span> thushanthsbm1997@gmail.com&nbsp;&nbsp;
          </h3>
        </div>
