                ...
                <div className="qualification__sections">
                    ...
                    <div className="qualification__data">
                            ...
                            <div>
                                ...
                                <div className="qualification__calendar">
                                    <i className='bx bx-calendar'></i> October 2024 to Present
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="qualification__data">
                            <div>
                                ...
                                <span className="qualification__subtitle">Procons Infotech (Pvt) Ltd - Nugegoda</span>
                                <div className="qualification__calendar">
                                    <i className='bx bx-calendar'></i> January 2023 to October 2024
                                </div>
                            </div>
                            <div>
                                <span className="qualification__rounder"></span>
                        ...
                        <div className="qualification__data">
                            ...
                            <div>
                                <h3 className="qualification__title">Software Engineer Internship</h3>
                                <span className="qualification__subtitle">My Dynamica (Pvt) Ltd - Jaffna</span>
                                <div className="qualification__calendar">
                                    <i className='bx bx-calendar'></i> January 2021 to July 2021
                                </div>
                            </div>
                        </div>
